...
export const siteConfig: SiteConfig = {
  ...
  description: "Een galerie van gevonden voorwerpen — gemengde media, sculptuur en de poëzie van assemblage in Marrakech.",
  brandName: "Trouvé",
}
...
export const galleryConfig: GalleryConfig = {
  ...
  stats: [
    ...
    { label: "OORSPRONG", value: "MARRAKECH" },
...
export const footerConfig: FooterConfig = {
  ...
  contactLinks: [
    ...
    { label: "Rue Mouassine, Marrakech", href: "#" },
  ],
